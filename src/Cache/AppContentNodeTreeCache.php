...
namespace Luminoslabs\OroVerticalMenu\Cache;
...
class AppContentNodeTreeCache extends ContentNodeTreeCache
{
    ...
    {
        parent::__construct($doctrineHelper, $cache);
    }
     ...
     * @param int $scopeId
     *
     * @return AppResolvedContentNode|null|bool The cached data or FALSE, if no cache entry exists
     */
    ...
    private function deserializeCachedNode(array $nodeData)
    {
        ...
        $resolvedNode = new AppResolvedContentNode(
            $nodeData['id'],
            $nodeData['identifier'],
            $titles,
            $resolvedVariant,
    ...
    private function convertResolvedContentNode(AppResolvedContentNode $resolvedNode): array
    {
        return [
            ...
            'hasHeading'          => $resolvedNode->getHasHeading()
        ];
    }
    ...
    private function convertObject($value): ?array
    {
        ...
        if ($value instanceof AppResolvedContentNode) {
