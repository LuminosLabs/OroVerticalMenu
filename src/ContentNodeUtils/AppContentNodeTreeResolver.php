...
namespace Luminoslabs\OroVerticalMenu\ContentNodeUtils;
...
class AppContentNodeTreeResolver extends ContentNodeTreeResolver
{
    ...
    public function __construct(
        ...
        parent::__construct($doctrineHelper, $contentNodeProvider, $scopeManager);
    }

    public function getResolvedContentNode(ContentNode $node, Scope $scope): ?AppResolvedContentNode
    {
        ...
        /** @var AppResolvedContentNode[] $resolvedNodes */
        $resolvedNodes = [];
     ...
     *
     * @return AppResolvedContentNode|null
     */
    private function createResolvedContentNode(
        ...
        return new AppResolvedContentNode(
            $nodeId,
